...
import { movingZerosToTheEnd } from "../fonction/movingZerosToTheEnd.js";
import assert from "assert";

/*-----  cas invalides -----*/
test("fonction movingZerosToTheEnd renvoie une erreur pour les entrées invalides", () => {
...
test("fonction movingZerosToTheEnd renvoie une erreur pour les nombres romains pas valides", () => {
...
/*-----  cas valides -----*/
test("fonction movingZerosToTheEnd renvoie le bon résultat", () => {
  const validCases = [
